import { CSSProperties, DOMAttributes, FormEvent, FormEventHandler, useContext, useEffect, useState } from "react"
    ...
    <>
      ...
      <div className="accordion" id="accordionExample">
        {questionsList.map((question) => (
          <QuestionBody key={question.id} question={question} canReply={canReply}/>
        ))}
      </div>
      <hr/>
        { !canReply &&
          ...
          <div className="mb-3">
            <label htmlFor="questionTextArea" className="form-label">Faça uma pergunta:</label>
            <textarea className="form-control" id="questionTextArea" name="questionTextArea" rows={3}></textarea>
          </div>
